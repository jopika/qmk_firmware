...
[1] = LAYOUT_65_ansi( /* FN */
    ...
    _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, _______, _______, _______, _______,  _______,         KC_MSTP, _______,\
...
[2] = LAYOUT_65_ansi( /* FN */
    ...
    _______, EF_DEC,  EF_INC,  H1_DEC,  H1_INC,  H2_DEC,  H2_INC,  BR_DEC,  BR_INC,  ES_DEC,  ES_INC,  _______,          KC_MSTP, _______,\
    KC_VOLU, KC_VOLD, KC_MUTE,                _______,                               _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT),
